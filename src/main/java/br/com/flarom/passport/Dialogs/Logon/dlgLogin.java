...
public class dlgLogin extends javax.swing.JDialog {
    ...
    public dlgLogin(java.awt.Frame parent) {
        ...
        setTitle("Passport "+vh.getLocalVersion());
    }
    ...
    private void initComponents() {
        ...
        lblIcon.setIcon(new ImageIcon(new ImageIcon(getClass().getResource("/images/passportFullWhite.png")).getImage().getScaledInstance(130, 25, Image.SCALE_SMOOTH)));
